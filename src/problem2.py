...
class Triangle(object):
    ...
    def area(self):
        ...
        a_c = self.a.distance_from(self.c)
        ...
        side_2 = s - a_c
        side_3 = s - b_c
        area = math.sqrt(s * side_1 * side_2 * side_3)
        return round(area, 0)
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        new_tri = Triangle(self.a, self.b, self.c)
        new_tri.a.x = new_tri.a.x * 2
        new_tri.a.y = new_tri.a.y * 2
        new_tri.b.x = new_tri.b.x * 2
        new_tri.b.y = new_tri.b.y* 2
        new_tri.c.x = new_tri.c.x * 2
        new_tri.c.y = new_tri.c.y * 2
        return new_tri
